...
contract ThrusterPool is IThrusterPool, NoDelegateCall {
    ...
    function initialize(uint160 sqrtPriceX96) external override {
        ...
        IBlastPoints(BLAST_POINTS).configurePointsOperator(IThrusterPoolFactory(factory).pointsAdmin());
        ...
        returns (uint256 amount0, uint256 amount1)
    {
        ...
        IThrusterMintCallback(msg.sender).uniswapV3MintCallback(amount0, amount1, data);
    ...
    function swap(
        ...
        if (zeroForOne) {
            ...
            IThrusterSwapCallback(msg.sender).uniswapV3SwapCallback(amount0, amount1, data);
